...
This is a sample template for NotifyOtpByConnect - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name notifyotpbyconnect --tail
```
...
```bash
aws cloudformation delete-stack --stack-name notifyotpbyconnect
```
